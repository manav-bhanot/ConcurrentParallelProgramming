...
class Ring {
	static public void main(String[] args) throws MPIException {
		...
		/*
		 * If we are the "master" process (i.e., MPI_COMM_WORLD rank 0), put the
		 * number of times to go around the ring in the message.
		 */
		
		// Processor 0 is the intiaitor of this communication

		if (0 == myrank) {
			message[0] = 10;

			System.out.println(
					"Process 0 sending " + message[0] + " to rank " + next + " (" + size + " processes in ring)");
		 ...
		 * Each time it passes through rank 0, it is decremented. When each processes
		...
		while (true) {
			...
			/*switch (myrank) {
			case 0: 
				System.out.println("Processor " + myrank + " receiving message from Processor " + prev);
				break;
			case 1: 
				System.out.println("Processor " + myrank + " receiving message from Processor " + prev);
				break;
			...
			// System.out.println("Processor " + next + " receiving message from Processor " + prev);
			...
			/*switch (prev) {
			case 0: 
				System.out.println("Processor " + myrank + " sending message to Processor " + next);
				break;
			case 1: 
				System.out.println("Processor " + myrank + " sending message to Processor " + next);
				break;
